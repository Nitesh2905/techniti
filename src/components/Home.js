...
const Home = () => {
  ...
  return (
    <div className="homepage">
      ...
      <div className="h-full w-full mt-5 absolute top-0 flex flex-col justify-center items-center ">
        <h1
          data-aos="fade-up"
      ...
      <div
        className="text-neutral-100 textsection min-h-full "
        style={backgroundImg}
      >
        <h2
          data-aos="fade-up"
        ...
        <p
          ...
          data-aos-easing="ease-in-sine"
          data-aos-duration="700"
          className="text-neutral-100 px-5 relative top-10 para-text text-center"
        >
        ...
        <p
          ...
          data-aos-easing="ease-in-sine"
          data-aos-duration="700"
          className="text-neutral-100 mt-5 leading-7 px-5 relative top-20 para-text text-center"
        >
        ...
        <p
          ...
          data-aos-easing="ease-in-sine"
          data-aos-duration="700"
          className="text-neutral-100 mt-5  top-10 leading-7  px-5 relative  para-text text-center"
        >
